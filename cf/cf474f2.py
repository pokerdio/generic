...
def make_segtree(s, st_gcd=None, st_min=None, st_min_count=None, idx=None, l=None, r=None):
    ...
    idx_l = 2 * idx + 1
    idx_r = idx_l + 1
    make_segtree(s, st_gcd, st_min, st_min_count, idx_l, l, mid)
    make_segtree(s, st_gcd, st_min, st_min_count, idx_r, mid, r)
    gcd1, min1, count1 = st_gcd[idx_l], st_min[idx_l], st_min_count[idx_l]
    gcd2, min2, count2 = st_gcd[idx_r], st_min[idx_r], st_min_count[idx_r]
