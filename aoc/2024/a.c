...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_s_666);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_s_666);
...
#define __pyx_kp_s_666 __pyx_mstate_global->__pyx_kp_s_666
 ...
 * print("666")             # <<<<<<<<<<<<<<
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_666) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
